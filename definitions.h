...
enum {
    TWOBWM_RESIZE_KEEP_ASPECT_GROW,
    TWOBWM_RESIZE_KEEP_ASPECT_SHRINK
};

enum {
    TWOBWM_MAXIMIZE_HORIZONTALLY,
    TWOBWM_MAXIMIZE_VERTICALLY
};
