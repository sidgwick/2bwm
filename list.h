...
void movetohead(struct item **mainlist, struct item *item) {  // Move element in item to the head of list mainlist.
...
void delallitems(struct item **list, int *stored) {  // Delete all elements in list and free memory resources.
    struct item *item;
    struct item *next;
